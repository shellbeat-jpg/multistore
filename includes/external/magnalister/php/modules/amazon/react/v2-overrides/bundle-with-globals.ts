...
import '../src/components/AmazonVariations/styles.css';

// Import the V2 wrapper component (includes v2-custom-styles.css)
import AmazonVariationsComponent from './AmazonVariationsV2Wrapper';
...
export {useAttributeForm} from '../src/hooks/useAttributeForm';
export {useApiIntegration, createApiErrorHandler} from '../src/hooks/useApiIntegration';
