<?php
/* -----------------------------------------------------------------------------------------
   $Id: admin_menu.php 16645 2025-11-26 18:11:54Z GTB $
  ...
  <?php
    ...
    if (isset($admin_access['paypal_banner']) && $admin_access['paypal_banner'] == '1') echo '<a class="configtab'.((basename($PHP_SELF) == 'paypal_banner.php') ? ' activ' : '').'" href="'.xtc_href_link('paypal_banner.php', '', 'NONSSL').'">'.TEXT_PAYPAL_TAB_BANNER.'</a>';
