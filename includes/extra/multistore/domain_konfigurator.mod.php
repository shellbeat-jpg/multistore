<?php
  ...
  # Paypal+ Modul 
  #$configuration_query = xtc_db_query("SELECT config_key as configuration_key, config_value as configuration_value FROM paypal_config");
  #while ($configuration_data = xtc_db_fetch_array($configuration_query)) {      
  # define($configuration_data['configuration_key'], $configuration_data['configuration_value']);   
  #}   
