<?php
  /* --------------------------------------------------------------
   $Id: xtcPrice.php 15108 2023-04-19 16:50:40Z GTB $
...
$mTypeArr[] = '<a class="submenutab'.$submenutabactiv.'" href="' . xtc_href_link(FILENAME_MODULES, 'set=xtcPrice') . '">' . BOX_MODULE_XTCPRICE . '</a>';